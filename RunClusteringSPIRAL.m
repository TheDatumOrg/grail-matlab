function RunClusteringSPIRAL(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    dlmwrite( strcat( 'RunClusteringSPIRAL/','RunClusteringSPIRAL_Dataset_', num2str(i)), Results, 'delimiter', '\t');
