function RunSVMClassifierSINKCompressed(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    KM = dlmread( strcat( 'KernelMatricesSINKCompressed/',char(Datasets(i)),'/', char(Datasets(i)), '_SINKComp_Gamma_', num2str(Thebestgamma3),'.kernelmatrix') );
                    ...
                    dlmwrite( strcat('RunSVMClassifierSINKCompressed/','RunSVMClassifierSINKComp_', num2str(i)), Results, 'delimiter', '\t');
...
function [Thebestgamma,Thebestcost,Thebestacc,Thebestiming] = GridSearchSVM1(GridStart,GridStep,GridEnd,TrainInstancesCount,TrainClassLabels,Datasets,DatasetsNumber,WarpValue)
                    ...
                    besttiming = zeros(1,length(log2cTmp));
                      ...
                      KM = dlmread( strcat( 'KernelMatricesSINKCompressed/',char(Datasets(DatasetsNumber)),'/', char(Datasets(DatasetsNumber)), '_SINKComp_Gamma_', num2str(gamma),'.kernelmatrix') );
