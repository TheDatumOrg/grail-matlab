function CollectStatistics(DataSetStartIndex, DataSetEndIndex, WindowPercent)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    ResultsTmp = dlmread( strcat('/rigel/dsi/users/ikp2103/VLDBGRAIL/RunOneNNDTW/', 'RunOneNNDTW_Dataset_', num2str(i), '_WindowPercent_', num2str(WindowPercent)) );
    ...
    dlmwrite( strcat( '/rigel/dsi/users/ikp2103/VLDBGRAIL/RESULTS_RunOneNNDTW_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex), '_WindowPercent_', num2str(WindowPercent) ), Results, 'delimiter', ',');
