function CollectStatistics(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    ResultsTmp = dlmread( strcat('RunSVMClassifierGAK/','RunSVMClassifierGAK_', num2str(i) ) );
    ...
    dlmwrite( strcat( '/rigel/dsi/users/ikp2103/VLDBGRAIL/RESULTS_RunSVMClassifierGAK_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex) ), Results, 'delimiter', ',');
