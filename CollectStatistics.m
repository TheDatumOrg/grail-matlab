function CollectStatistics(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    ResultsTmp = dlmread( strcat('RunSVMClassifierSINK/','RunSVMClassifierSINK_', num2str(i)) );
    ...
    dlmwrite( strcat( '/rigel/dsi/users/ikp2103/VLDBGRAIL/RESULTS_RunSVMClassifierSINK_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex) ), Results, 'delimiter', ',');
