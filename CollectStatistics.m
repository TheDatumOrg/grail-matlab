function CollectStatistics(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    ResultsTmp = dlmread( strcat('/rigel/dsi/users/ikp2103/JOPA/GRAIL2/RunOneNNSBD/', 'RunOneNNSBD_Dataset_', num2str(i)) );
    ...
    dlmwrite( strcat( '/rigel/dsi/users/ikp2103/JOPA/GRAIL2/RESULTS/RunOneNNSBD_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex)), Results, 'delimiter', ',');
