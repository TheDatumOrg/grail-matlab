function FastSVMClassifierSINK(DataSetStartIndex, DataSetEndIndex)  
    ...
    %WarpValues = [6,12,0,0,5,0,17,0,0,0,0,11,10,9,16,0,13,12,9,6,16,5,1,5,2,3,4,11,2,0,15,6,4,0,0,5,11,0,11,12,0,0,0,12,13,0,13,18,6,2,6,0,1,12,0,11,1,4,4,10,2,7,12,2,16,15,3,4,0,0,12,0,1,0,0,6,1,0,8,13,0,19,8,9,10];
