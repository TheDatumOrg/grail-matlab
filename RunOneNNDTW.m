function RunOneNNDTW(DataSetStartIndex, DataSetEndIndex,WindowPercent)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex && i<=DataSetEndIndex)
                    ...
                    dlmwrite( strcat('/rigel/dsi/users/ikp2103/JOPA/GRAIL2/RunOneNNDTW/', 'RunOneNNDTW_Dataset_', num2str(i), '_WindowPercent_', num2str(WindowPercent)), Results, 'delimiter', '\t');
